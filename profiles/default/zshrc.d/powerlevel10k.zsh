# Generated by Powerlevel10k configuration wizard on 2023-08-24 at 11:53 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='${${${EUID:#0}:+❯}:-#}'
